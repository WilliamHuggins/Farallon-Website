...
const platforms: Platform[] = [
  ...
  },
  {
    ...
    iconPath: (
      <path d="M10.8 16.2c0 1.7-1.3 3-3 3s-3-1.3-3-3 1.3-3 3-3c.4 0 .8.1 1.2.3V5.5L19 3.9v9.7c0 1.7-1.3 3-3 3s-3-1.3-3-3 1.3-3 3-3c.4 0 .8.1 1.2.3v-8l-8.2 1.6v8.7z" />
    )
  },
  {
    name: 'YouTube Music',
